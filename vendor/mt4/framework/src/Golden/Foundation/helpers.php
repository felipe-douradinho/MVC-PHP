...
use Golden\Support\Arr;
use Golden\Support\Str;
use Golden\View\ViewEngine;
...
if (! function_exists('collect')) {
	 ...
	 *
	 * @param  mixed  $value
	 * @return \Golden\Support\Collection
	 */
...
if (! function_exists('get_env'))
{
	...
	{
		return Application::getDotData($key);
	}
}
...
if (! function_exists('route'))
{
	 ...
	 * @throws Exception
	 */
	function route($name, $parameter = null)
	{
		return Application::getRouter()->getRouteByName($name, $parameter);
	}
}
...
if (! function_exists('asset'))
{
	...
	function asset($uri = '')
	{
		return \Golden\Foundation\Application::getAppUrl() . '/' . ltrim($uri, '/');
	}
}
